<template>
    <div class="d-flex align-items-center">
        ...
        <div contenteditable="true" @blur="onUpdateContactInfo($event, 'phone')">{{contact.phone}}</div>
    ...
    <div class="d-flex align-items-center">
        ...
        <div contenteditable="true" @blur="onUpdateContactInfo($event, 'email')">{{contact.email}}</div>
    </div>
    <div class="d-flex align-items-center">
        ...
        <div contenteditable="true" @blur="onUpdateContactInfo($event, 'address')">{{contact.address}}</div>
    </div>
</template>
